...
public class SuperCar : ISuperCar
{
    ...
    {
        Console.WriteLine($"The {CarType} is a super car. It's a {Color} car and costs {Price} dollars.");
    }

    public void GonnaGoFast()
    {
        Console.WriteLine($"The {CarType}'s gonna go fast! Kachow!");
    }
